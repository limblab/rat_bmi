...
temp = an_data.data(:,3:end);  % I think these are the good channels
...
figure; 
data_plot = temp2 + sep_fact*[1:size(an_data.data(:, idx), 2)];
plot(xvals, data_plot);
...
figure; 
data_plot = temp2pca + sep_fact*[1:size(an_data.data(:, idx), 2)];
plot(xvals, data_plot);
